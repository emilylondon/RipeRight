...
const HomeScreen = () => {
  ...
  const [scannedDevices, dispatch] = useRe  ducer(reducer, []);
  ...
  const ListHeaderComponent = () => (
    <View style={styles.body}>
      <View style={styles.sectionContainer}>
        <Text style={styles.sectionTitle}>RipeRight</Text>
        <Text style={styles.sectionSubtitle} >Check your fruit ripeness!</Text>
      </View>
      <View style={styles.sectionContainer}>
        <Text>To Begin, please pair a scanner</Text>
        <Button
          title="Clear devices"
